...
define('REDIR_INDEX', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/index.php");
define('REDIR_HEADER', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/partials/header.php");
define('REDIR_FOOTER', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/partials/footer.php");
define('REDIR_PARTIALS', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/partials");

define('REDIR_AUTH', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/auth");
define('REDIR_CONTROLLERS', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/controllers");
define('REDIR_DB', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/db");
define('REDIR_REPOSITORIES', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/db/repositories");
define('REDIR_SECURITY', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/controllers/security.php");
define('REDIR_VIEWS', $_SERVER['DOCUMENT_ROOT'] .ROOT . "/views");
